...
- [overview.md](./overview.md) — описание, особенности, приватность
- [manifest-permissions.md](./manifest-permissions.md) — разрешения браузера
- [user-journey.md](./user-journey.md) — пользовательские пути
- [fr-requirements.md](./fr-requirements.md) — функциональные требования
- [ui-requirements.md](./ui-requirements.md) — UX/UI требования (цвет, иконка, контекстное меню)
