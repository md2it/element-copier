...
export const DE_MESSAGES: Strings = {
  restrictedPageNotice:
    "Browser-Erweiterungen funktionieren nicht auf Systemseiten und geschützten Websites. Versuche es auf einer anderen Seite.",
  panelSubtitle: "Browser-Erweiterung",
  titleSettings: "START",
  pickElementButtonLabel: "ELEMENT WÄHLEN",
  capturePageButtonLabel: "SEITE SCREENSHOT",
  ...
  settingsDefaultActionCopyFullXPath: "Vollständiges XPath kopieren",
  settingsDefaultActionCopyStyles: "styles kopieren",
  settingsDefaultActionCopyComputedStyles: "computed styles kopieren",
  ...
  formatStyles: "styles",
  formatXPath: "XPath",
  formatFullXPath: "VOLLSTÄNDIGES XPath",
  formatText: "TEXT",
  ...
  aboutBullets: [
    ...
    "Texte: formatiert, rein, Markdown, HTML",
    "Bilder: PNG, JPEG",
    "Code-Selektoren: Selektor, JS-Pfad, XPath, vollständiges XPath",
