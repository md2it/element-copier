...
export const DE_MESSAGES: Strings = {
  ...
  settingsComputeFormatsHint: "Ausschalten, um die Verarbeitung zu beschleunigen:",
  settingsComputeImagesLabel: "Bilder generieren",
  settingsComputeMarkdownLabel: "Markdown generieren",
  settingsComputeTextLabel: "Text berechnen",
