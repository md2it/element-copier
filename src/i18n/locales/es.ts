...
export const ES_MESSAGES: Strings = {
  restrictedPageNotice:
    "Las extensiones no funcionan en páginas del sistema ni en sitios protegidos. Prueba en otro sitio.",
  ...
  settingsComputeFormatsHint: "Desactiva para reducir el tiempo de procesamiento:",
  settingsComputeImagesLabel: "Generar imágenes",
  settingsComputeMarkdownLabel: "Generar markdown",
  settingsComputeTextLabel: "Calcular texto",
