...
export const FR_MESSAGES: Strings = {
  restrictedPageNotice:
    "Les extensions ne fonctionnent pas sur les pages système ni les sites protégés. Essayez un autre site.",
  ...
  settingsComputeFormatsHint: "Désactivez pour réduire le temps de traitement :",
  settingsComputeImagesLabel: "Générer les images",
  settingsComputeMarkdownLabel: "Générer le markdown",
  settingsComputeTextLabel: "Calculer le texte",
