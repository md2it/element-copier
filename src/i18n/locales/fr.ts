...
export const FR_MESSAGES: Strings = {
  ...
  settingsDefaultActionCopyFullXPath: "Copier XPath complet",
  settingsDefaultActionCopyStyles: "Copier styles",
  settingsDefaultActionCopyComputedStyles: "Copier computed styles",
