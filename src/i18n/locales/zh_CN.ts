...
export const ZH_CN_MESSAGES: Strings = {
  ...
  settingsDefaultActionCopyJsPath: "复制 JS path",
  settingsDefaultActionCopyXPath: "复制 XPath",
  settingsDefaultActionCopyFullXPath: "复制完整 XPath",
  settingsDefaultActionCopyStyles: "复制 styles",
  settingsDefaultActionCopyComputedStyles: "复制 computed styles",
  ...
  aboutBullets: [
    ...
    "下载",
    "记住最近的快照",
    "文本：格式化、纯文本、markdown、HTML",
    "图片：PNG、JPEG",
    "代码选择器：选择器、JS path、XPath、完整 XPath",
