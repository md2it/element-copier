...
export const RU_MESSAGES: Strings = {
  ...
  settingsComputeFormatsHint: "Выключите, чтобы ускорить обработку:",
  settingsComputeImagesLabel: "Генерировать изображения",
  settingsComputeMarkdownLabel: "Генерировать markdown",
  settingsComputeTextLabel: "Вычислять текст",
