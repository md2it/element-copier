...
export const AR_MESSAGES: Strings = {
  ...
  settingsDefaultActionCopyStyles: "نسخ styles",
  settingsDefaultActionCopyComputedStyles: "نسخ computed styles",
  ...
  copiedSubtitlePrefix: "نُسخ إلى حافظة النصوص:",
  ...
  copiedImageClipboardUnsupportedTooltip:
    "لا يستطيع متصفحك نسخ هذا التنسيق إلى حافظة النصوص. استخدم «تنزيل» بدلًا من ذلك.",
  ...
  aboutBullets: [
    "النسخ إلى حافظة النصوص",
    "التنزيل",
    "يحفظ اللقطات الأخيرة",
    "نصوص: منسّق، عادي، markdown، HTML",
    "صور: PNG، JPEG",
    "مُحدِّدات الكود: مُحدِّد، JS path، XPath، XPath كامل",
